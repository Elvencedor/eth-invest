<template>
  <section class="flex justify-center items-center flex-col py-20 px-6 sm:px-0">
    ...
    <div class="w-full max-w-sm">
      <form @submit.prevent="registerRequest()" class="bg-gray-800 p-6 rounded-lg mt-10">
        <div>
          <label for="fullname" class="text-white">Full name</label>
          <input type="text" v-model="$v.form.fullName.$model" class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" id="fullname">
          <p class="text-xs text-red-500 italic" v-if="$v.form.fullName.$error && !$v.form.fullName.required">Name is required!</p>
        </div>
        <div class="mt-6">
          <label for="email" class="text-white">E-mail</label>
          <input @input="suggestUsername" type="text" v-model.trim="$v.form.email.$model" class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" id="email">
        ...
        <div class="mt-6">
          ...
          <input @input="$v.form.username.$model = String($v.form.username.$model).toLowerCase()" type="text" v-model.trim="$v.form.username.$model" class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" id="username">
        ...
        <div class="mt-6">
          ...
          <input type="password" v-model="$v.form.password.$model" class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" id="password">
        ...
        <div v-if="form.referrer" class="mt-6">
          <label for="referrer" class="text-white">Referrer</label>
          <input type="text" readonly v-model="$v.form.referrer.$model" class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" id="referrer">
        ...
        <div class="mt-6 flex items-center">
          ...
          <p class="text-white ml-4">I agree with <router-link to="/terms" class="text-red-500">Terms and Conditions</router-link></p>
        </div>
        <div class="mt-6">
          <button
            type="submit"
