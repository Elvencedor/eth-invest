  ...
  <section class="flex justify-center items-center flex-col pt-2 mt-20 px-6 sm:px-10 md:px-20 lg:px-40">
    ...
    <div class="w-full max-w-xl text-center mt-10">
      <div class="flex flex-wrap">
        <div class="w-1/3">
          <a href="http://t.me/CrespoCSO" class="block border-2 border-red-500 rounded m-4 p-4 text-white text-center text-sm hover:bg-red-500 hover:text-gray-900" title="Telegram">
            <i class="fab fa-telegram fa-2x"></i>
            <div class="mt-2">Telegram</div>
          </a>
        </div>
        <div class="w-1/3">
          <a href="https://twitter.com/clubcrespo/" class="block border-2 border-red-500 rounded m-4 p-4 text-white text-center text-sm hover:bg-red-500 hover:text-gray-900" title="Twitter">
            <i class="fab fa-twitter fa-2x"></i>
            <div class="mt-2">Twitter</div>
          </a>
        </div>
        <div class="w-1/3">
          <a href="mailto:cresposachi@gmail.com" class="block border-2 border-red-500 rounded m-4 p-4 text-white text-center text-sm hover:bg-red-500 hover:text-gray-900" title="Mail">
    ...
    <div class="w-full max-w-xl">
      <form @submit.prevent="submit" class="bg-gray-800 py-6 rounded-lg mt-10">
        <div class="flex flex-wrap">
          <div class="w-full sm:w-1/2 px-6">
            ...
            <input 
              ...
              class="mt-3 w-full rounded-lg py-3 px-6 bg-gray-900 text-white" 
              id="name" 
              placeholder=""
            >
            <p 
